...
function bp_import_blog_activity_admin_add() {
	add_submenu_page( 'bp-general-settings', __('Import Blog Activity','bp-import-blog-activity'), __('Import Blog Activity','bp-import-blog-activity'), 'manage_options', __FILE__, 'bp_import_blog_activity_admin_screen' );
}
